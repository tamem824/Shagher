<x-guest.layouts.app :categories="$categories">
    <div class="container py-5" style="max-width: 700px;">
        ...
        <div class="card shadow-sm border-0" style="border-radius: 1rem; background-color: #f8e1f4;">
            <div class="card-body">
                <h2 class="card-title mb-4 text-center" style="color: #b83280;">Create Job</h2>

                <form action="{{ route('admin.jobs.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    @method('POST')
